...
os.system('mkdir ../results/rcnn/'+EXP_NAME)
clean_models = 1;
if (CLEAN_MODELS == 'NO'):
    clean_models = 0;
...
exp_folder = '../results/rcnn/'+EXP_NAME+'/'
...
#all  output to ../results/rcnn/exp_name
...
for epoch in epochs:
    ...
    f.write(str(epoch)+',')
    f.close()
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_val1 voc_boat_train1_'+str(epoch)+' '+train_val_file1)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file1+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_train1 voc_boat_train1_'+str(epoch)+' '+train_val_file1)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file1+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    f = open(train_val_file1, 'a+')
    #remove extra comma
...
for epoch in epochs:
    ...
    f.write(str(epoch)+',')
    f.close()
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_val2 voc_boat_train2_'+str(epoch)+' '+train_val_file2)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file2+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_train2 voc_boat_train2_'+str(epoch)+' '+train_val_file2)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file2+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    f = open(train_val_file2, 'a+')
    #remove extra comma
...
for epoch in epochs:
    ...
    f.write(str(epoch)+',')
    f.close()
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_val3 voc_boat_train3_'+str(epoch)+' '+train_val_file3)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file3+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_train3 voc_boat_train3_'+str(epoch)+' '+train_val_file3)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file3+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    f = open(train_val_file3, 'a+')
    #remove extra comma
...
for epoch in epochs:
    ...
    f.write(str(epoch)+',')
    f.close()
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_val4 voc_boat_train4_'+str(epoch)+' '+train_val_file4)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file4+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_train4 voc_boat_train4_'+str(epoch)+' '+train_val_file4)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+train_val_file4+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    f = open(train_val_file4, 'a+')
    #remove extra comma
...
for epoch in epochs:
    ...
    f.write(str(epoch)+',')
    f.close()
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_test voc_boat_trainval_'+str(epoch)+' '+trainval_test_file)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+trainval_test_file+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_trainval voc_boat_trainval_'+str(epoch)+' '+trainval_test_file)
    os.system('matlab -nojvm -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';output_file=\''+trainval_test_file+'\';score;exit;catch;exit(1);end"')
    os.system('rm -rf ../HydroTestSuite/proposals/rcnn/*')
    f = open(trainval_test_file, 'a+')
    #remove extra comma
...
os.system('CUDA_VISIBLE_DEVICES='+DEVICE+' python testRCNN.py voc_boat_test voc_boat_trainval_'+str(best_epoch))
os.system('matlab -nodesktop -nosplash -r "try;addpath(\'../HydroTestSuite/\');method=\'RCNN\';display=\'NO\';drawProposals;exit;catch;exit(1);end"')

os.system('cp models/training/rcnn_boat_models/'+best_model_name + ' '+exp_folder+best_model_name)
os.system('mkdir '+ exp_folder+'proposals/')
os.system('cp -R ../HydroTestSuite/proposals/rcnn/* ' + exp_folder+'proposals/')
